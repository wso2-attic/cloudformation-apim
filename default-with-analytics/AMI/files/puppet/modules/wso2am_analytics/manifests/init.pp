...
class wso2am_analytics (
  ...
  $install_java           = $wso2am_analytics::params::install_java,
  $java_install_dir       = $wso2am_analytics::params::java_install_dir,
  $java_source_file       = $wso2am_analytics::params::java_source_file,
  $java_user              = $wso2am_analytics::params::java_user,
  $java_group             = $wso2am_analytics::params::java_group,
  ...
  $autostart_service      = $wso2am_analytics::params::autostart_service,
