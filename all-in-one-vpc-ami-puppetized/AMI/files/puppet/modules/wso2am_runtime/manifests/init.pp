...
class wso2am_runtime (
  ...
  $install_java           = $wso2am_runtime::params::install_java,
  $java_install_dir       = $wso2am_runtime::params::java_install_dir,
  $java_source_file       = $wso2am_runtime::params::java_source_file,
  $java_user              = $wso2am_runtime::params::java_user,
  $java_group             = $wso2am_runtime::params::java_group,
